		...
		requirejs: {
			...
			file: {
				options: {
					...
					name: 'backbone-ui-draggable',
					// output here
					out: './built/backbone-ui-draggable.js',
					// config file
					...
					exclude: ["bb-model-view", "jquery", "lowercase-backbone", "lodash", "object-query"],
			...
			full: {
				options: {
					...
					name: 'backbone-ui-draggable',
					// output here
					out: './built/backbone-ui-draggable.full.js',
					// config file
					mainConfigFile: 'amdconfig.js',
					...
					// exclude these modules AND their dependencies
					// (excluding your bower dependencies)
					exclude: ["bb-model-view", "jquery-ui", "object-query"],
